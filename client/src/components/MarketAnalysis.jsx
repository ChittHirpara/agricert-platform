...
import { X, TrendingUp, TrendingDown, AlertCircle, BrainCircuit, DollarSign, Activity } from 'lucide-react';
        ...
        <div className="p-6 border-b border-gray-800 flex justify-between items-center bg-gray-900">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 font-mono uppercase flex items-center gap-2">
                Predictive Analytics <Activity size={10} className="text-purple-500" /> {batch.productType}
              </p>
            </div>
          </div>
