...
import { X, ShieldCheck, Lock, Terminal, Server, Database, CheckCircle, Cpu, Hash } from 'lucide-react';
      ...
      >
        ...
        <div className="border-t border-green-500/30 p-4 bg-gray-900 flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-green-400 uppercase flex items-center gap-2">
              {verificationStatus === 'success' ? <><Hash size={10} /> Consensus Reached Block #893210</> : 'Auditing Smart Contract Nodes...'}
            </span>
          </div>
