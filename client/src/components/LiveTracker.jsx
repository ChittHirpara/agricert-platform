...
import { X, Satellite, Thermometer, Droplets, Navigation, Wifi, Truck, Map, Globe, MapPin } from 'lucide-react';
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-4 left-4 bg-black/60 backdrop-blur p-2 rounded border border-gray-600 flex items-center gap-2">
              ...
              <span className="text-green-500 font-mono text-xs flex items-center gap-2">
                LIVE SATELLITE FEED <MapPin size={10} className="animate-pulse" /> <span className="animate-pulse text-red-500">REC</span>
              </span>
            </div>
          </div>
        </div>
